 ...
 * (see lib/docstore). Holds OAuth tokens, recaps, settings.
 *
 * Every doc is namespaced per teacher (`recaps:<teacherId>`), so two teachers
 * never share a calendar connection or a recap draft. The id is
