...
export default async function OnboardingPage() {
  ...
  const { data: profile } = await supabase
    .from('profiles')
    .select('role, full_name, teaching_language, speaking_language, teaching_platform, meeting_platform, calendar_mode, onboarding_step, onboarding_completed_at, brand')
    .eq('id', user.id)
    .single()
