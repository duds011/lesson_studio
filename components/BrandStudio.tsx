...
const SAMPLE: DashboardData = {
  ...
  cardLessons: [
    { id: 'l12', number: 12, title: 'Talking about travel', total: 9, due: 4 },
    { id: 'l11', number: 11, title: 'Joining two ideas', total: 7, due: 2 },
    { id: 'l10', number: 10, title: 'Describing where you live', total: 6, due: 0 },
  ],
  cardMastery: { known: 24, learning: 31, new: 18 },
  practiceDays: [
    { day: '2026-09-01', label: '1 Sep', cards: 12 },
    { day: '2026-09-02', label: '2 Sep', cards: 0 },
    { day: '2026-09-03', label: '3 Sep', cards: 24 },
    { day: '2026-09-04', label: '4 Sep', cards: 12 },
    { day: '2026-09-05', label: '5 Sep', cards: 0 },
    { day: '2026-09-06', label: '6 Sep', cards: 0 },
    { day: '2026-09-07', label: '7 Sep', cards: 12 },
    { day: '2026-09-08', label: '8 Sep', cards: 25 },
    { day: '2026-09-09', label: '9 Sep', cards: 12 },
    { day: '2026-09-10', label: '10 Sep', cards: 0 },
    { day: '2026-09-11', label: '11 Sep', cards: 12 },
    { day: '2026-09-12', label: '12 Sep', cards: 12 },
    { day: '2026-09-13', label: '13 Sep', cards: 0 },
    { day: '2026-09-14', label: '14 Sep', cards: 12 },
  ],
  cardTotal: 73,
  cardDue: 37,
  talkDelta: 8,
